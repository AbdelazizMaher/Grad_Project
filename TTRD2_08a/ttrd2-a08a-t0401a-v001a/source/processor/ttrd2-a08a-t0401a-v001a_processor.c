...
void PROCESSOR_Configure_Reqd_MoSt(void)
   ...
   switch (Processor_MoSt_g)
      ...
      case NORMAL_M:
         ...
         //           A                  B  C
         SCH_Add_Task(DUMMY_TASK_Update, 0,  1);    // 0-iWDT
         SCH_Add_Task(DUMMY_TASK_Update, 0,  100);  // 1-Heartbeat
         //SCH_Add_Task(DUMMY_TASK_Update, 0, 100);    // 2-Switch
         SCH_Add_Task(DUMMY_TASK_Update, 0,  50);  // 3-ADC1    
         SCH_Add_Task(DUMMY_TASK_Update, 0,  100);  // 4-Proc task     
         //SCH_Add_Task(DUMMY_TASK_Update, 0,  1);    // 5-UART2
				 
         SCH_Add_Task(DUMMY_TASK_Update, 1,  20);    // 6-EPS_Health_Req
         SCH_Add_Task(DUMMY_TASK_Update, 2,  20);    // 7-COMMS_Health_Req
         SCH_Add_Task(DUMMY_TASK_Update, 3,  20);    // 8-COMMS_WOD_Rep
         SCH_Add_Task(DUMMY_TASK_Update, 4,  20);    // 9-EPS_exHealth_Req
         SCH_Add_Task(DUMMY_TASK_Update, 5,  20);    // 10-ADCS_exHealth_Req
         SCH_Add_Task(DUMMY_TASK_Update, 6,  20);    // 11-COMMS_exHealth_Req
         SCH_Add_Task(DUMMY_TASK_Update, 7,  20);    // 12-COMMS_EXT_WOD_Rep
         SCH_Add_Task(DUMMY_TASK_Update, 1,  100);    // 13-IDLE
         SCH_Add_Task(DUMMY_TASK_Update, 2,  100);    // 14-SCH-SE
         SCH_Add_Task(DUMMY_TASK_Update, 5,  20);    // 15-ADCvbat
         SCH_Add_Task(DUMMY_TASK_Update, 0,  1);    // 16-OBC_UART
