   ...
   switch (Processor_MoSt_g)
      ...
      case NORMAL_M:
        ...
        // SCH_Add_Task(SWITCH_BUTTON1_Update, 10, 2,   8,  7);    // Switch
         ...
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 1,  20, 5000,   2);    // EPS_Health_Req
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 2,  20, 5000,   2);    // COMMS_Health_Req
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 3,  20, 5000,   2);    // COMMS_WOD_Rep
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 4,  20, 5000,   2);    // EPS_exHealth_Req
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 5,  20, 5000,   2);    // ADCS_exHealth_Req
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 6,  20, 5000,   2);    // COMMS_exHealth_Req
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 7,  20, 5000,   2);    // COMMS_EXT_WOD_Rep
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 8,  20, 5000,   2);    // IDLE
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 9,  20, 5000,   2);    // SCH-SE
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 10,  20, 5000,   2);    // ADCvbat
         SCH_Add_Task(HELLOWORLD_TRANSMIT_Update, 0,  1, 5000,   2);    // OBC_UART
