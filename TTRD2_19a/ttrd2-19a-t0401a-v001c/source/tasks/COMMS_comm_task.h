...
extern uint8_t COMMS_U4_SP_Flag;
extern char COMMS_U4_SP_Command[10];
...
//void     COMMS_U4_BUF_O_Write_Number10_To_Buffer(const uint32_t DATA);
//void     COMMS_U4_BUF_O_Write_Number04_To_Buffer(const uint32_t DATA);
//void     COMMS_U4_BUF_O_Write_Number03_To_Buffer(const uint32_t DATA);
//void     COMMS_U4_BUF_O_Write_Number02_To_Buffer(const uint32_t DATA);
