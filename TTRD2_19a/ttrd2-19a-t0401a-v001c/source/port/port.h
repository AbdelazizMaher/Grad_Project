...
// COMMS_U4 interface
#define COMMS_U4_PORT_RCC		 	 RCC_AHB1Periph_GPIOC
#define COMMS_U4_UART_RCC			 RCC_APB2Periph_USART6
#define COMMS_U4_DMA_RCC		 		 RCC_AHB1Periph_DMA2
#define COMMS_U4_DMA_RX_STREAM	 DMA2_Stream2
#define COMMS_U4_DMA_TX_STREAM	 DMA2_Stream7
#define COMMS_U4_DMA_Channel	   DMA_Channel_5
#define COMMS_U4_PORT        	 GPIOC
#define COMMS_U4_UARTX          USART6 
#define COMMS_U4_AF		         GPIO_AF_USART6 
#define COMMS_U4_TX_PIN      	 GPIO_Pin_6
#define COMMS_U4_RX_PIN      	 GPIO_Pin_7
#define COMMS_U4_TX_PIN_SOURCE	 GPIO_PinSource6
#define COMMS_U4_RX_PIN_SOURCE	 GPIO_PinSource7
...
//#define ADCS_U6_DMA_TX_STREAM	 DMA2_Stream7
...
//#define EPS_U1_DMA_RX_STREAM	 DMA2_Stream2
...
// EPS_U1 interface
#define EPS_U1_PORT_RCC		 	     RCC_AHB1Periph_GPIOD
#define EPS_U1_UART_RCC			     RCC_APB1Periph_USART3
#define EPS_U1_DMA_RCC		 		   RCC_AHB1Periph_DMA1
#define EPS_U1_DMA_RX_STREAM	   DMA1_Stream1
#define EPS_U1_DMA_TX_STREAM	   DMA1_Stream3
#define EPS_U1_DMA_Channel	     DMA_Channel_4
#define EPS_U1_PORT        	     GPIOD
#define EPS_U1_UARTX             USART3 
#define EPS_U1_AF		             GPIO_AF_USART3 
#define EPS_U1_TX_PIN      	     GPIO_Pin_8
#define EPS_U1_RX_PIN      	     GPIO_Pin_9
#define EPS_U1_TX_PIN_SOURCE	   GPIO_PinSource8
#define EPS_U1_RX_PIN_SOURCE	   GPIO_PinSource9
