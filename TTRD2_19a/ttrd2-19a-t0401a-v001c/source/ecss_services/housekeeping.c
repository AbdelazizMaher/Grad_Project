...
uint8_t EPS_WOD_FLAG = false;
uint8_t ADCS_WOD_FLAG = false;
    ...
    if(sid == EX_HEALTH_REP) {
       ...
       // pkt->data[size] = ms_res;
        ...
        pkt->len = size;
			...
			{
//				if( COMMS_WOD_FLAG == false || EPS_WOD_FLAG == false || ADCS_WOD_FLAG == false)
//				{
//					
//				}
...
//*************************************** comms_REP*****************************************//
 ...
 //*************************************** obc_REP*****************************************//
			...
			cnv32_8(Boot_Cnt_EPS, &pkt->data[size]);
			size +=4;
